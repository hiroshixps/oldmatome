...
SCategory.create(:s_category => 'docomo(ドコモ)携帯電話', :l_id =>4, :m_id =>15)
SCategory.create(:s_category => 'au携帯電話', :l_id =>4, :m_id =>15)
SCategory.create(:s_category => 'SoftBank(ソフトバンク)携帯電話', :l_id =>4, :m_id =>15)
SCategory.create(:s_category => 'WILLCOM(ウィルコム)携帯電話', :l_id =>4, :m_id =>15)
SCategory.create(:s_category => 'ワイモバイル携帯電話', :l_id =>4, :m_id =>15)
SCategory.create(:s_category => 'ディズニー・モバイル携帯電話', :l_id =>4, :m_id =>15)
...
SCategory.create(:s_category => 'USBメモリー', :l_id =>1, :m_id =>22)
SCategory.create(:s_category => 'SDメモリーカード', :l_id =>1, :m_id =>22)
SCategory.create(:s_category => 'メモリースティック', :l_id =>1, :m_id =>22)
SCategory.create(:s_category => 'コンパクトフラッシュ', :l_id =>1, :m_id =>22)
SCategory.create(:s_category => 'xDピクチャーカード', :l_id =>1, :m_id =>22)
SCategory.create(:s_category => 'スマートメディア', :l_id =>1, :m_id =>22)
